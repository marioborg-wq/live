...
const Icon = {
  Pin: ({ filled = false, size = 16, color }) => (
    <img
      src={filled ? 'assets/pin-selected.svg' : 'assets/pin-not-selected.svg'}
      width={size}
      height={size}
      alt=""
      style={{ display: 'block' }}
...
function TopHeader({ pinnedCount }) {
  return (
    <div style={{
      ...
      <img src="assets/logo-kto.svg" alt="KTO" style={{ height: 22 }}/>
  ...
  return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 4px 6px' }}>
      ...
      {onToggleAll ? (
        ...
        >
          <img
            src={allOpen ? 'assets/icon-close-all.svg' : 'assets/icon-open-all.svg'}
...
// ========== LEAGUE ACCORDION ==========
function LeagueAccordion({ league, country, count, expanded, onToggle, isPinned, onTogglePin, children }) {
  return (
      ...
      >
        <button
          ...
          style={{
            ...
            color:'#fff', textAlign:'left', height:'100%', padding: 0,
          }}
        >
        ...
        <div style={{ display:'flex', alignItems:'center', gap: 10 }}>
          ...
          {onTogglePin && (
            ...
            >
              <Icon.Pin filled={isPinned} size={18} color={isPinned ? '#fad749' : '#828282'}/>
            </button>
          )}
          <button
            onClick={onToggle}
